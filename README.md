...
List files, preview images or plain text, and save a verified copy to the Mac.
...
`genomewalker/relay-plugin-artifacts` and its exact tag, review the digest and
...
Files up to 8 MiB; image previews are downsampled and text previews limited to 128 KiB. Markdown is shown as text. No HTML execution or recursive discovery.

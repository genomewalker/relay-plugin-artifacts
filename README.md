...
Preview agent-generated images, Markdown and tables with their source host and project.
...
- [ ] Define artifact events and host/project-scoped file access.
- [ ] Implement bounded decoding and explicit fetch with size/type limits.
- [ ] Render Markdown without executable HTML; never execute artifact contents.
- [ ] Test large/malformed files, changing sources, dismiss/reopen behavior and offline hosts.
